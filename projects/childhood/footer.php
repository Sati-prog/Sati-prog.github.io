			...
			<div class="reply">
				<div class="reply__body">
						...
						<?php echo do_shortcode('[contact-form-7 id="158" title="Вопросы"]'); ?>
				</div>
			</div>
			<footer>
					<div class="container">
			...
			<?php 
					wp_footer();
			?>
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-TYb9gUIfYWdVQxSRnPtP4fyra5CQ8MI"></script>
